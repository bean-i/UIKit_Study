...
final class ViewController: UIViewController {
    ...
    lazy var emailInfoLabelCenterYConstrait = emailInfoLabel.centerYAnchor.constraint(equalTo: emailTextFieldView.centerYAnchor)
    lazy var passwordInfoLabelCenterYConstrait = passwordInfoLabel.centerYAnchor.constraint(equalTo: passwordTextFieldView.centerYAnchor)
...
//            emailInfoLabel.centerYAnchor.constraint(equalTo: emailTextFieldView.centerYAnchor),
            emailInfoLabelCenterYConstrait,
...
//            passwordInfoLabel.centerYAnchor.constraint(equalTo: passwordTextFieldView.centerYAnchor),
            passwordInfoLabelCenterYConstrait,
...
// MARK: - UITextFieldDelegate (텍스트필드 관련 델리게이트)(확장)
...
extension ViewController: UITextFieldDelegate {
    ...
    func textFieldDidBeginEditing(_ textField: UITextField) {
        if textField == emailTextField {
            ...
            // 오토레이아웃 업데이트
            emailInfoLabelCenterYConstrait.constant = -13
        }
        ...
        if textField == passwordTextField {
            ...
            // 오토레이아웃 업데이트
            passwordInfoLabelCenterYConstrait.constant = -13
        }
    ...
    func textFieldDidEndEditing(_ textField: UITextField) {
        if textField == emailTextField {
            ...
            if emailTextField.text == "" {
                ...
                emailInfoLabelCenterYConstrait.constant = 0
            }
        }
        ...
        if textField == passwordTextField {
            ...
            if passwordTextField.text == "" {
                ...
                passwordInfoLabelCenterYConstrait.constant = 0
            }
        }
